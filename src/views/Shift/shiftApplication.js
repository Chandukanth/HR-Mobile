...
const ShiftApplications = () => {
    ...
    return (
        <Layout title={'Shift Applications'}>
                    ...
                    <View style={{ alignItems: 'center', paddingTop: 20 }}>
                        <View style={styles.card}>
                            ...
                            <View style={{ flexDirection: 'row' }}>
                                <TouchableOpacity style={{ width: '40%', height: 40, backgroundColor: 'black', borderRadius: 2, justifyContent: 'center', alignItems: 'center', marginTop: 20, marginLeft: 20, marginBottom: 10 }}>
                                    <Text style={{ color: 'white', fontFamily: 'Poppins-Light' }}>Approve</Text>
                                </TouchableOpacity>
                                <TouchableOpacity style={{ width: '40%', height: 40, backgroundColor: 'white', borderWidth : 1, borderRadius: 2, justifyContent: 'center', alignItems: 'center', marginTop: 20, marginLeft: 10, marginBottom: 10 }}>
                                    <Text style={{ color: 'black', fontFamily: 'Poppins-Light' }}>Reject</Text>
                                </TouchableOpacity>
                            </View>
